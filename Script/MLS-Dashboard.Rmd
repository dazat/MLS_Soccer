...
A copy of my data can be found at:
[Player_Data](https://github.com/dazat/MLS_Soccer/blob/main/Script/player_data.csv)

*I am sorry the button below does not currently work*
